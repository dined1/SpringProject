                            ...
                            <div class="col-lg-12">
                                <form role="form" action="${contextPath}/admin/characteristics/new" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" pattern="[a-zA-Z0-9- ]+" name="CharacteristicValue" path="CharacteristicValue" title="Only numbers and english letters" required="required" />
                                    </div>
