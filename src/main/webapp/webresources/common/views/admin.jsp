...
<div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav in" id="side-menu">
                    ...
                    <li>
                        <a href="${contextPath}/adm/catalog/${CUSTOMER.customerId}">Offering catalog</a>
                    </li>
                    <li>
                        <a href="${contextPath}/adm/discounts/${CUSTOMER.customerId}">Offering discounts catalog</a>
                    </li>
                    <li>
                        <a href="${contextPath}/adm/groups/${CUSTOMER.customerId}">Offering groups</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="${contextPath}/adm/customerinfo/${CUSTOMER.customerId}">Customer information</a>
                    </li>
                    <li>
    ...
    <div id="page-wrapper" style="min-height: 476px;">
        ...
        <c:if test="${fn:contains(requestScope['javax.servlet.forward.request_uri'], '/catalog')}">
            <%@ include file="/webresources/common/views/item/list.jsp"%>
        </c:if>
        <c:if test="${fn:contains(requestScope['javax.servlet.forward.request_uri'], '/groups')}">
            <%@ include file="/webresources/common/views/group/list.jsp"%>
        </c:if>
        ...
        <c:if test="${fn:endsWith(requestScope['javax.servlet.forward.request_uri'], '/adm/'.concat(CUSTOMER.customerId))}">
        <div>
            <div class="row">
                <div class="col-lg-12">
