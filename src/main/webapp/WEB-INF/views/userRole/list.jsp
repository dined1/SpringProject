                                                ...
                                                <div class="pull-right">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu pull-right" role="menu">
                                                            ...
                                                            <li><a href="${contextPath}/admin/userRole/update/${USER_ROLE.id}"><i class="fa fa-edit fa-fw"></i>  Edit</a></li>
                                                            <li class="divider"></li>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <form action="${contextPath}/admin/userRole/remove/${USER_ROLE.id}" method="DELETE">
